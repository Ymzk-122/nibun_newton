...
class VCanvas {
  ...
  rect( x, y, w, h ) {
    // 長方形を描画
    var x1 = (x - this._scaleLeft) * this._canvas.width / this._scaleWidth * this._dir_x;
		var y1 = (y - this._scaleTop) * this._canvas.height / this._scaleHeight * this._dir_y;


		this._context.fillRect( x1,y1,5,5 );
	}
